...
cc.Class({
    ...
    _playBgm() {
        if (!this.bgm) { cc.warn('[BGM] counterGame: this.bgm is NULL at runtime (clip not wired/loaded)'); return; }
        cc.log('[BGM] counterGame: playing', this.bgm && this.bgm.name, '| vol', this.bgmVolume);
