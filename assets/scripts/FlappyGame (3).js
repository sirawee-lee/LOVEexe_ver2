...
cc.Class({
  ...
  _playBgm() {
    if (!this.bgm) { cc.warn('[BGM] flappy1: this.bgm is NULL at runtime (clip not wired/loaded)'); return; }
        cc.log('[BGM] flappy1: playing', this.bgm && this.bgm.name, '| vol', this.bgmVolume);
